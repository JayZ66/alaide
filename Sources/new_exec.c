...
int	handle_redirections(t_token **current, t_minishell *minishell,
...
int	is_pipe_command(t_token **current)
{
...
void	moove_to_next_token(t_token **current)
{
...
int	exec_loop(t_token **current, t_minishell *minishell,
...
void	type_of_cmd(t_token **current, t_minishell *minishell,
